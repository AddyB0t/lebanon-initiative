...
export const helplines: Helpline[] = [
  {
    ...
    description_en: 'Direct support from Lebanon Gender Initiative',
    description_ar: 'دعم مباشر من مبادرة لبنان للمساواة',
    description_fr: 'Soutien direct de l\'Initiative Genre Liban',
